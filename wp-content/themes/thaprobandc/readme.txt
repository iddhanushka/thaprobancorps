...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/thaproband.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/thaproband)

## About

I’m a huge fan of Underscores, Bootstrap, and Sass. Why not combine these into a solid WordPress Theme Framework?
That’s what thaproband is. 
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for thaproband.

At the moment, thaproband is in a very early stage. But if you want, feel free to use it for your own WordPress theme!

# thaproband WordPress Theme Framework

Website: [https://thaproband.com](https://thaproband.com)

Child Theme Project: [https://github.com/holger1411/thaproband-child](https://github.com/holger1411/thaproband-child)

## License
thaproband WordPress Theme, Copyright 2013-2017 Holger Koenemann
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or thaproband variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "thaproband/thaproband"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the thaproband folder from GitHub or from thaproband.com
